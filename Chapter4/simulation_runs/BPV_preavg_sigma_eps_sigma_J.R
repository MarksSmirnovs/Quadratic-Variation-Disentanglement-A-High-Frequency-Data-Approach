...
sigma_eps_grid = c(0.0005, 0.001)
jumps_std_grid = c(0,0.00075,0.00115,0.0015)
...
sim_result = lapply( X = 1:nrow(Paramater_sets), function(params_idx){
  ...
  clusterExport(cl = cluster, "sigma_eps", environment())
...
saveRDS(sim_result, file = "BPV_preAvg_sim2.rds")